...
# Las reglas se evalúan EN ORDEN. La precedencia importa: las más
# críticas/restrictivas van primero, igual que en el Taller 1 del PDF
# (la regla de rechazo absoluto debía evaluarse antes que la de
# aprobación).
REGLAS: list[Regla] = [
    Regla(
